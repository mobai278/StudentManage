#pragma checksum "C:\Users\86138\Downloads\Compressed\ASP.NET学生管理系统(公众号：程序员小R)\StudentManage\StudentManage\Views\Home\Class\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "f2eac1d9a12c26c9a1d6d60fcedf7836c38c889e"
// <auto-generated/>
#pragma warning disable 1591
[assembly: global::Microsoft.AspNetCore.Razor.Hosting.RazorCompiledItemAttribute(typeof(AspNetCore.Views_Home_Class_Index), @"mvc.1.0.view", @"/Views/Home/Class/Index.cshtml")]
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"f2eac1d9a12c26c9a1d6d60fcedf7836c38c889e", @"/Views/Home/Class/Index.cshtml")]
    ...
    #nullable restore
    public class Views_Home_Class_Index : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    #nullable disable
    {
        ...
        public async override global::System.Threading.Tasks.Task ExecuteAsync()
        {
            WriteLiteral("\n");
#nullable restore
#line 2 "C:\Users\86138\Downloads\Compressed\ASP.NET学生管理系统(公众号：程序员小R)\StudentManage\StudentManage\Views\Home\Class\Index.cshtml"
...
#nullable disable
    ...
    <div style=""display: inline-block;"">
        ...
        <div class=""layui-inline"">
            <input class=""layui-input"" name=""name"" id=""name"" autocomplete=""off"" placeholder=""请输入班级名称"">
        </div>
...
");
    ...
    <div class=""layui-form layui-form-pane"" style=""padding:10px"">
        ...
        <");
            ...
            <div class=""layui-input-block"">
                <textarea id=""box_description"" name=""description"" placeholder=""请输入班级描述"" class=""layui-textarea""></textarea>
            </div>
        </div>
        ...
        function () {
            ...
            function initIndex() {
                table.render({
                    id: 'List',
                    elem: '#tableList',
                    url: '/StudentManage/Class/List',
                    title: '班级数据表',
                    cols: [
                        [
                            { type: 'checkbox', fixed: 'left' },
                            { f");
            WriteLiteral(@"ield: 'id', title: 'ID', width: 80, fixed: 'left', unresize: true, sort: true },
                            { field: 'majorId', title: 'majorId', width: 80, fixed: 'left', unresize: true, sort: true },
                            { field: 'serialNumber', title: '班级编号', width: 300, align: 'center' },
                            { field: 'name', title: '班级名称', width: 350, align: 'center' },
                            { field: 'majorName', title: '所属专业', width: 1000, align: 'center' },
                            { field: 'description', title: '班级描述', width: 350, align: 'center' },
       ...
       ");
            ...
            function initForm(formObj, dataObj) {
                ...
                $.ajax({
                    ...
                    ");
            WriteLiteral(@"            $(""#box_name"").val(dataObj.name);
                ...
                form.on('submit(submitForm)',
                    function (data) {
                        var url = '/StudentManage/Class/Add';
                        if (!!data.field.id) {
                            url = '/StudentManage/Class/Edit';
                        }
                        $.ajax({
                            type: ""POST"",
                            url: url,
...
");
            WriteLiteral(@"                                    type: ""POST"",
                                    url: '/StudentManage/Class/Delete',
                                    data: { id: data.id },
                                    dataType: ""json"",
                                    beforeSend: function () {
                                    },
            ...
            WriteLiteral(@"                               error: function (XMLHttpRequest, textStatus, errorThrown) {
                    ...
                    if (obj.event === 'edit') {
                        var editForm = layer.open({
                            ...
                            ca");
            WriteLiteral(@"ncel: function (index) { //窗口关闭按钮事件
                                layer.close(index);
                            }
                        });
